...
const NotFound = () => {
    ...
    return (
        <div className="flex items-center justify-center h-screen bg-[#F9F9F9]">
            <div className="w-fit h-fit p-20 bg-[#B72024] rounded-xl flex flex-col items-center justify-center gap-6">
                <h1 className="text-white text-center font-bold text-5xl">✖️ERROR 404✖️</h1>
                <h1 className="text-white text-center text-3xl font-semibold font-poppins">Yahhh, Page Yang Anda Cari Tidak Ada😭 </h1>
